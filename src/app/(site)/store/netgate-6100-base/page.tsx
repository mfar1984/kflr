...
export default function Netgate6100BASEDetailPage() {
          ...
          <div className="row gy-4">
            <div className="col-lg-6">
              <div className="mb-3 bg-white p-4 rounded text-center" style={{ minHeight: "400px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <img src={mainImage} alt="Netgate 6100 BASE" className="img-fluid" style={{ maxHeight: "400px" }} />
              </div>
            ...
            <div className="col-lg-6">
              ...
              <h2 className="mb-2" style={{ fontSize: "1.75rem" }}>Netgate 6100 BASE pfSense+ Security Gateway</h2>
              <div className="mb-3">
                {[...Array(5)].map((_, i) => (
              ...
              <p className="mb-3" style={{ fontSize: "0.95rem" }}>
                One of the most versatile security gateways in its class. Intel C3558 Quad Core CPU with integrated QuickAssist Technology delivers 
                over 18 Gbps routing across 8 independent ports including 10 GbE SFP+, 2.5 GbE, and 1 GbE options.
              </p>
            ...
            <div className="tab-pane fade show active" id="overview">
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <p>The Netgate® 6100 with pfSense® Plus software is one of the most versatile security gateways in its class. It combines the power of an Intel C3558 Quad Core CPU with integrated QuickAssist Technology (QAT) & AES-NI and 8 GB of memory for a snappy user experience.</p>
                  <p>Delivers over <strong>18 Gbps of L3 routing</strong> across 8 independent ports: 2x 10 GbE SFP+, 2x 1 GbE Combo (RJ45/SFP), and 4x 2.5 GbE. The 6100 is capable of performing high-throughput firewall, routing, and VPN applications. Despite its powerful performance, the 6100 operates in near-silent passive cooling mode.</p>

                  <h5 className="mt-4 mb-2" style={{ fontSize: "1.1rem" }}>Best For:</h5>
                  <ul className="small">
                    <li>Prosumers & Power Users</li>
                    <li>Remote Workers</li>
                    <li>Small to Medium-Sized Business Networks</li>
                    <li>Branch Office</li>
                    <li>MSP/MSSP On-Premises Appliance</li>
                    <li>Enterprise deployments</li>
                    <li>High-Speed Gigabit Connections</li>
                  </ul>
                </div>
                  ...
                  <div className="card bg-primary text-white">
                    <div className="card-body">
                      ...
                      <ul className="list-unstyled">
                        ...
                        <li className="mb-2"><i className="bi bi-check-circle me-2"></i>21.3 GB eMMC Storage</li>
              ...
              <div className="table-responsive">
                <table className="table table-striped table-hover table-sm">
                  <tbody style={{ fontSize: "0.9rem" }}>
                    ...
                    <tr><th>Storage</th><td>21.3 GB eMMC (upgradeable to 128GB NVMe with MAX version)</td></tr>
                ...
                <div className="col-md-4">
                  <div className="card text-center h-100">
                    <div className="card-body p-3">
                      ...
                      <div><small className="d-block text-muted">IMIX Traffic</small><span className="h5 text-primary mb-0">High Performance</span></div>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="card text-center h-100">
                    <div className="card-body p-3">
                      ...
                      <div><small className="d-block text-muted">Enterprise Grade</small><span className="h5 text-primary mb-0">✓</span></div>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="card text-center h-100">
                    <div className="card-body p-3">
                      ...
                      <div><small className="d-block text-muted">Hardware Accelerated</small><span className="h5 text-primary mb-0">✓</span></div>
                    </div>
                  </div>
                </div>
              </div>
