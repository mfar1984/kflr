...
export default function Netgate8200MAXDetailPage() {
  const [mainImage, setMainImage] = useState("/assets/img/store/netgate8200/8200_front_angle.jpg");
  const [selectedPowerCord, setSelectedPowerCord] = useState("USA (IEC Type A)");
  const [quantity, setQuantity] = useState(1);

  const productImages = [
    { src: "/assets/img/store/netgate8200/8200_front_angle.jpg", alt: "Front angle" },
    { src: "/assets/img/store/netgate8200/8200_front.jpg", alt: "Front view" },
    { src: "/assets/img/store/netgate8200/8200_rear_angle.jpg", alt: "Rear angle" },
    { src: "/assets/img/store/netgate8200/8200_top.jpg", alt: "Top view" },
    { src: "/assets/img/store/netgate8200/8200_bottom.jpg", alt: "Bottom view" },
    { src: "/assets/img/store/netgate8200/8200_ha_front.jpg", alt: "HA configuration" },
  ];
          ...
          <div className="row gy-4">
            <div className="col-lg-6">
              <div className="mb-3 bg-white p-4 rounded text-center" style={{ minHeight: "400px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <img src={mainImage} alt="Netgate 8200 MAX" className="img-fluid" style={{ maxHeight: "400px" }} />
              </div>
            ...
            <div className="col-lg-6">
              ...
              <h2 className="mb-2" style={{ fontSize: "1.75rem" }}>Netgate 8200 MAX pfSense+ Security Gateway</h2>
              <div className="mb-3">
              ...
              <p className="mb-3" style={{ fontSize: "0.95rem" }}>
                Enterprise-grade security gateway with Intel C3758 8-core processor @ 2.2 GHz and 16 GB RAM. 
                Features 128 GB NVMe SSD and delivers over 18 Gbps routing with advanced QuickAssist Technology.
              </p>
          ...
          <div className="tab-content">
            <div className="tab-pane fade show active" id="overview">
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <p>The Netgate® 8200 MAX is an enterprise-grade security gateway featuring an Intel C3758 8-core processor @ 2.2 GHz with QuickAssist Technology (QAT) and 16 GB DDR4 RAM. The MAX version includes 128 GB NVMe SSD for extensive logging and package storage.</p>
                  <p>Delivers exceptional <strong>18.50 Gbps routing performance</strong> with 8 independent network ports. Perfect for medium to large enterprises requiring high-throughput firewall, VPN, and advanced security features.</p>

                  <h5 className="mt-4 mb-2" style={{ fontSize: "1.1rem" }}>Best For:</h5>
                  <ul className="small">
                    <li>Medium to Large Enterprises</li>
                    <li>Branch Office deployments</li>
                    <li>MSP/MSSP Service Providers</li>
                    <li>High-availability environments</li>
                    <li>Multi-WAN configurations</li>
                    <li>Advanced IDS/IPS deployments</li>
                  </ul>
                </div>
                  ...
                  <div className="card bg-primary text-white">
                    <div className="card-body">
                      ...
                      <ul className="list-unstyled">
                        ...
                        <li className="mb-2"><i className="bi bi-check-circle me-2"></i>9.93 Gbps Firewall</li>
                        <li className="mb-2"><i className="bi bi-check-circle me-2"></i>1.77 Gbps IPsec VPN</li>
                        <li className="mb-2"><i className="bi bi-check-circle me-2"></i><strong>Intel C3758 8-core @ 2.2GHz</strong></li>
                        <li className="mb-2"><i className="bi bi-check-circle me-2"></i><strong>16 GB DDR4 RAM</strong></li>
                        ...
                        <li className="mb-2"><i className="bi bi-check-circle me-2"></i>4M Connections</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="table-responsive">
                <table className="table table-striped table-hover table-sm">
                  <tbody style={{ fontSize: "0.9rem" }}>
                    ...
                    <tr><th>Storage</th><td>128 GB NVMe M.2 SSD</td></tr>
                    ...
                    <tr><th>USB Ports</th><td>2x USB 3.0 Type-A</td></tr>
                    <tr><th>Power</th><td>12V DC External Power Supply</td></tr>
                    <tr><th>Cooling</th><td>Passive (fanless)</td></tr>
            ...
            <div className="tab-pane fade" id="performance">
              ...
              <div className="alert alert-info mt-4">
                ...
                <p className="mb-0 small">Maximum Active Connections: <strong>4,000,000</strong>. QuickAssist Technology provides hardware-accelerated encryption.</p>
              </div>
            </div>
