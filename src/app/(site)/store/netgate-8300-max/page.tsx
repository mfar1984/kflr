...
export default function Netgate8300MAXDetailPage() {
          ...
          <div className="row gy-4">
            <div className="col-lg-6">
              <div className="mb-3 bg-white p-4 rounded text-center" style={{ minHeight: "400px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <img src={mainImage} alt="Netgate 8300 MAX" className="img-fluid" style={{ maxHeight: "400px" }} />
              </div>
            ...
            <div className="col-lg-6">
              ...
              <h2 className="mb-2" style={{ fontSize: "1.75rem" }}>Netgate 8300 MAX pfSense+ Security Gateway</h2>
              <div className="mb-3">
              ...
              <p className="mb-3" style={{ fontSize: "0.95rem" }}>
                Enterprise 1U rackmount security gateway with Intel C3758 8-core processor @ 2.2 GHz, 16 GB RAM, and 128 GB NVMe SSD. 
            ...
            <div className="tab-pane fade show active" id="overview">
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <p>The Netgate® 8300 MAX is a premium 1U rackmount security gateway powered by Intel C3758 8-core processor @ 2.2 GHz with QuickAssist Technology. With 16 GB DDR4 RAM, 128 GB NVMe SSD, and flexible expansion options for high-speed networking, it&apos;s designed for demanding enterprise environments.</p>
