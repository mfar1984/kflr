...
export default function Netgate8300TAADetailPage() {
          ...
          <div className="row gy-4">
            <div className="col-lg-6">
              <div className="mb-3 bg-white p-4 rounded text-center" style={{ minHeight: "400px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <img src={mainImage} alt="Netgate 8300 TAA" className="img-fluid" style={{ maxHeight: "400px" }} />
              </div>
            ...
            <div className="col-lg-6">
              <div className="mb-2">
                <span className="badge bg-info me-2">Pre Order</span>
                <span className="badge bg-success">TAA Compliant</span>
              </div>
              <h2 className="mb-2" style={{ fontSize: "1.75rem" }}>Netgate 8300 TAA pfSense+ Security Gateway</h2>
              <div className="mb-3">
              ...
              <p className="mb-3" style={{ fontSize: "0.95rem" }}>
                TAA-compliant enterprise 1U rackmount security gateway with Intel C3758 8-core processor @ 2.2 GHz, 16 GB RAM, and 128 GB NVMe SSD. 
                Perfect for government and regulated environments. Supports high-speed expansion cards for 25GbE/100GbE connectivity.
              </p>
            ...
            <div className="tab-pane fade show active" id="overview">
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <p>The Netgate® 8300 TAA is a TAA-compliant premium 1U rackmount security gateway powered by Intel C3758 8-core processor @ 2.2 GHz with QuickAssist Technology. With 16 GB DDR4 RAM, 128 GB NVMe SSD, and flexible expansion options for high-speed networking, it&apos;s designed for government and regulated enterprise environments.</p>
              ...
              <div className="table-responsive">
                <table className="table table-striped table-hover table-sm">
                  <tbody style={{ fontSize: "0.9rem" }}>
                    ...
                    <tr><th>Certifications</th><td><strong>TAA Compliant</strong>, CE, FCC, RoHS</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
